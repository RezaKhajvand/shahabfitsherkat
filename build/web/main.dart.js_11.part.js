...
al(){this.aA()
this.Ak()},
Ak(){var x=0,w=A.v(y.b),v=this
var $async$Ak=A.q(function(d,e){if(d===1)return A.r(e,w)
...
$0(){var x=this.a.c
x.toString
return A.ci(x).Oj("/manage",null,y.a)},
