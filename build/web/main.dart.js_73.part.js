...
this.b=e},
beJ(d,e){return new A.zq("HTTP request failed, statusCode: "+d+", "+e.j(0))},
...
o.addEventListener("load",B.co(new A.asr(o,p,r)))
o.addEventListener("error",B.co(new A.ass(p,o,r)))
o.send()
x=3
...
if(t.byteLength===0)throw B.d(A.beJ(B.V(o,"status"),r))
n=d
x=4
return B.M(B.ank(t),$async$wk)
case 4:v=n.$1(f)
x=1
break
...
var $async$$0=B.u(function(d,e){if(d===1)return B.v(e,w)
while(true)switch(x){case 0:s=A.bl2()
r=u.b.a
s.src=r
x=3
return B.M(B.f7(s.decode(),y.X),$async$$0)
case 3:t=A.beO(B.cS(new A.wu(s,r),y.J),null)
t.e=r
v=t
x=1
break
