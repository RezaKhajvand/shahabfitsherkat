...
b5Z(d){switch(d.a){case 0:return"\u062a\u0645\u0631\u06cc\u0646\u06cc"
case 1:return"\u063a\u0630\u0627\u06cc\u06cc"}},
Ty:function Ty(d,e){this.a=d
this.b=e},
adw(d,e){var x=0,w=A.y(y.g),v,u=2,t=[],s,r,q,p,o
var $async$adw=A.t(function(f,g){if(f===1){t.push(g)
x=u}while(true)switch(x){case 0:p=A.a1(["text",d,"type",B.b5Z(e)],y.g,y.b)
u=4
x=7
return A.M($.cL().dK("description").ol(0,p),$async$adw)
case 7:s=g
...
x(B.Ty,A.ey)})()
var y={g:A.G("k"),b:A.G("@")};(function constants(){C.qb=new B.Ty(0,"tamrin")
C.NW=new B.Ty(1,"qazae")
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_124",e:"endPart",h:b})})($__dart_deferred_initializers__,"d+LGH1BlwqZjqgjY1SeWWK9bKRs=");