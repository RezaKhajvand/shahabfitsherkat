...
b5X(d){switch(d.a){case 0:return"\u062a\u0645\u0631\u06cc\u0646\u06cc"
case 1:return"\u063a\u0630\u0627\u06cc\u06cc"}},
Tx:function Tx(d,e){this.a=d
this.b=e},
adv(d,e){var x=0,w=A.y(y.g),v,u=2,t=[],s,r,q,p,o
var $async$adv=A.t(function(f,g){if(f===1){t.push(g)
x=u}while(true)switch(x){case 0:p=A.a1(["text",d,"type",B.b5X(e)],y.g,y.b)
u=4
x=7
...
x(B.Tx,A.ey)})()
var y={g:A.G("k"),b:A.G("@")};(function constants(){C.qb=new B.Tx(0,"tamrin")
C.NW=new B.Tx(1,"qazae")
