...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1265: (x0,x1) => x0.createElement(x1),
      _1266: () => globalThis.registerFingerprintCredential(),
      _1267: x0 => globalThis.authenticateWithFingerprint(x0),
      _1273: (x0,x1) => x0.createElement(x1),
      _1279: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1280: () => globalThis.Notification.requestPermission(),
      _1281: x0 => x0.load(),
      _1282: x0 => x0.play(),
      _1283: x0 => x0.pause(),
      ...
      _1319: (x0,x1) => globalThis.downloadPdf(x0,x1),
      _1320: (x0,x1) => x0.getItem(x1),
      _1321: (x0,x1) => x0.removeItem(x1),
      _1322: (x0,x1,x2) => x0.setItem(x1,x2),
      _1324: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1325: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1326: x0 => globalThis.firebase_core.getApp(x0),
      _1327: () => globalThis.firebase_core.getApp(),
      _1329: (x0,x1) => ({next: x0,error: x1}),
      _1330: x0 => ({vapidKey: x0}),
      _1331: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1333: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1335: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1339: x0 => x0.title,
      _1340: x0 => x0.body,
      _1341: x0 => x0.image,
      _1342: x0 => x0.messageId,
      _1343: x0 => x0.collapseKey,
      _1344: x0 => x0.fcmOptions,
      _1345: x0 => x0.notification,
      _1346: x0 => x0.data,
      _1347: x0 => x0.from,
      _1348: x0 => x0.analyticsLabel,
      _1349: x0 => x0.link,
      ...
      _1375: x0 => x0.name,
      _1376: x0 => x0.options,
      _1377: (x0,x1) => x0.debug(x1),
      _1378: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1378(f,arguments.length,x0) }),
      _1379: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1379(f,arguments.length,x0,x1) }),
      _1380: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1381: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1382: (x0,x1) => x0.createScriptURL(x1),
      _1383: (x0,x1,x2) => x0.createScript(x1,x2),
      _1384: (x0,x1) => x0.appendChild(x1),
      ...
      _1460: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1462: o => o instanceof Uint8Array,
      _1463: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1464: o => o instanceof Int8Array,
      _1465: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1466: o => o instanceof Uint8ClampedArray,
      _1467: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1468: o => o instanceof Uint16Array,
      _1469: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1470: o => o instanceof Int16Array,
      _1471: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1472: o => o instanceof Uint32Array,
      _1473: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1474: o => o instanceof Int32Array,
      _1475: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1477: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1478: o => o instanceof Float32Array,
      _1479: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1480: o => o instanceof Float64Array,
      _1481: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1482: (t, s) => t.set(s),
      _1483: l => new DataView(new ArrayBuffer(l)),
      _1484: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1485: o => o.byteLength,
      _1486: o => o.buffer,
      _1487: o => o.byteOffset,
      _1488: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1489: (b, o) => new DataView(b, o),
      _1490: (b, o, l) => new DataView(b, o, l),
      _1491: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1492: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1493: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1494: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1495: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1496: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1497: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1498: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1499: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1500: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1501: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1502: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1505: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1506: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1507: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1508: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1509: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1510: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1512: () => globalThis.performance,
      _1513: () => globalThis.JSON,
      _1514: x0 => x0.measure,
      _1515: x0 => x0.mark,
      _1516: x0 => x0.clearMeasures,
      _1517: x0 => x0.clearMarks,
      _1518: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1519: (x0,x1,x2) => x0.mark(x1,x2),
      _1520: x0 => x0.clearMeasures(),
      _1521: x0 => x0.clearMarks(),
      _1522: (x0,x1) => x0.parse(x1),
      _1523: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1524: (handle) => clearTimeout(handle),
      _1525: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1526: (handle) => clearInterval(handle),
      _1527: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1528: () => Date.now(),
      _1533: o => Object.keys(o),
      _1534: () => new XMLHttpRequest(),
      _1535: (x0,x1,x2) => x0.open(x1,x2),
      _1536: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1537: x0 => x0.abort(),
      _1538: (x0,x1) => x0.send(x1),
      _1539: x0 => x0.send(),
      _1540: x0 => x0.getAllResponseHeaders(),
      _1541: () => new AbortController(),
      _1542: x0 => x0.abort(),
      _1543: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1544: (x0,x1) => globalThis.fetch(x0,x1),
      _1545: (x0,x1) => x0.get(x1),
      _1546: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1546(f,arguments.length,x0,x1,x2) }),
      _1547: (x0,x1) => x0.forEach(x1),
      _1548: x0 => x0.getReader(),
      _1549: x0 => x0.read(),
      _1550: x0 => x0.cancel(),
      _1553: (x0,x1) => x0.item(x1),
      ...
      _1567: x0 => x0.trustedTypes,
      _1568: (x0,x1) => { x0.text = x1 },
      _1577: (s, m) => {
        try {
      ...
      _1650: () => globalThis.document,
      _1656: (x0,x1) => { x0.height = x1 },
      _1658: (x0,x1) => { x0.width = x1 },
      _1667: x0 => x0.style,
      _1670: x0 => x0.src,
