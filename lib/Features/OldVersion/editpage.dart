...
class _EditPageState extends State<EditPage> {
  ...
  void initState() {
    super.initState();
    planindex = planlist.indexOf(widget.shagerd.plan);
    typeindex = widget.shagerd.khosusi ? 1 : 0;
    namecontroler.text = widget.shagerd.name;
    phonecontroler.text = replaceFarsiNumber(widget.shagerd.phone);
    workouttimeindex = int.parse(widget.shagerd.workouttime);
