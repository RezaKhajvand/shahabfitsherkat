...
BasketActivity basketActivityFromJson(String str) =>
    BasketActivity.fromJson(json.decode(str));
...
class BasketActivity {
  ...
  factory BasketActivity.fromJson(Map<String, dynamic> json) => BasketActivity(
        page: json["page"],
        perPage: json["perPage"],
        totalItems: json["totalItems"],
        totalPages: json["totalPages"],
        items: List<ActivityItem>.from(
            json["items"].map((x) => ActivityItem.fromJson(x))),
      );
}
